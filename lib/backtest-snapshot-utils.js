...
function normalizeSnapshotItem(item = {}, snapshot = {}) {
  ...
  return {
    ...
    accelerationState: item.accelerationState ?? null,
    accelerationLabel: item.accelerationLabel ?? null,
    accelerationScore: num(item.accelerationScore),
    accelerationReasons: Array.isArray(item.accelerationReasons) ? item.accelerationReasons : [],
    accelerationWarnings: Array.isArray(item.accelerationWarnings) ? item.accelerationWarnings : [],
    accelerationMode: item.accelerationMode ?? null,
